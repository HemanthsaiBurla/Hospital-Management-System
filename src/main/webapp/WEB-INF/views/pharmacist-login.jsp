...
<head>
    ...
    <title>Pharmacist Login - Hospital Management System</title>
...
<body>
    ...
    <div class="login-container">
        ...
        <div class="login-form">
            ...
            <form action="${pageContext.request.contextPath}/pharmacist/login" method="post">
                ...
                <button type="submit" class="login-btn">
                    <i class="fas fa-sign-in-alt"></i> Login to Pharmacy Portal
                </button>
            </form>
        </div>
